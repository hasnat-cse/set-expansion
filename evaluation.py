def main():
    ...
    output_list = ['John Abbott', 'Arthur Meighen', 'Pierre Trudeau', 'Alexander Mackenzie', 'John Diefenbaker', 'Lester B. Pearson', 'Louis St. Laurent', 'Wilfrid Laurier', 'Robert Borden', 'John A. Macdonald', 'Charles Tupper', 'Mackenzie Bowell', 'Joe Clark', 'Brian Mulroney', 'Paul Martin', 'Jean Chrétien', 'Kim Campbell', 'Stephen Harper', 'John Turner', 'William Lyon Mackenzie King', 'R. B. Bennett', 'John Thompson', 'R.B. Bennett']
