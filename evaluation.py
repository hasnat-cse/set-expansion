def main():
    ...
    output_list = ['Paul Martin', 'John Thompson', 'Wildfrid Laurier', 'John Turner', 'Stephen Harper', 'Jean Chrétien', 'Pierre Trudeau', 'Brian Mulroney', 'Joe Clark', 'Kim Campbell', 'Louis St. Laurent', 'Lester B. Pearson', 'John Diefenbaker', 'Alexander Mackenzie', 'Arthur Meighen', 'William Lyon Mackenzie King', 'Wilfrid Laurier', 'Robert Borden', 'John A. Macdonald', 'Charles Tupper', 'Mackenzie Bowell', 'Sir Wilfrid Laurier', 'John Abbott']
