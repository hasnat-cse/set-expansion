def main():
    ...
    output_list = ['Stephen Harper', 'John Turner', 'Paul Martin', 'Brian Mulroney', 'Louis St. Laurent', 'Pierre Trudeau', 'John Thompson', 'Jean Chrétien', 'Lester B. Pearson', 'Arthur Meighen', 'Joe Clark', 'John Diefenbaker', 'Kim Campbell', 'Alexander Mackenzie', 'John A. Macdonald', 'Mackenzie Bowell', 'William Lyon Mackenzie King', 'Charles Tupper', 'John Abbott', 'Robert Borden', 'R. B. Bennett', 'Jim Boeheim', 'Bob Knight']
