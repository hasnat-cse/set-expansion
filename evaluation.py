def main():
    ...
    output_list = ['Edmonton', 'Calgary', 'Leduc', 'Vancouver', 'Winnipeg', 'St. Albert', 'Lacombe', 'Ponoka', 'Stettler', 'Cardston', 'Camrose', 'Olds', 'Taber', 'Sedgewick', 'Grouard', 'Lac Ste. Anne', 'Didsbury', 'Gleichen', 'Edson']
