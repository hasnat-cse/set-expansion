def main():
    ...
    output_list =   ['University of Toronto', 'Algoma University', 'OCAD University', 'Saint Paul University', 'Tyndale University College', 'Dominican University College', 'Redeemer University College', 'Nipissing University', 'Trent University', 'Laurentian University', 'Ryerson University', 'Brock University', 'University of Guelph', 'Wilfrid Laurier University', 'University of Western Ontario', 'Lakehead University', 'University of Windsor', 'McMaster University', 'University of Waterloo']
