def main():
    ...
    output_list = ['Dominica', 'Canada', 'Saint Lucia', 'Saint Kitts and Nevis', 'Grenada', 'Antigua and Barbuda', 'Belize', 'Haiti', 'Guyana', 'Barbados', 'Nicaragua', 'Suriname', 'El Salvador', 'British Virgin Islands', 'Honduras', 'Swaziland', 'Kiribati', 'Montserrat', 'Turks and Caicos Islands', 'Anguilla', 'Cape Verde', 'Trinidad and Tobago']
