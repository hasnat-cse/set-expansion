...
def static_seisa(seed_entities, entity2features, alpha):
    ...
    # final sorting after getting ESS
    sim_score_dict = {}
    combined_score_dict = {}
    ...
    ranked_expanded_entities = sorted_candidate_entities[:k]

    print("Expanded entities after Static Seisa: %s" % ranked_expanded_entities)
    return ranked_expanded_entities
...
def static_seisa_optimized(seed_entities, entity2features, feature2entities, alpha):
    ...
    print("Expanded entities length: %s" % len(ranked_expanded_entities))
    print("Expanded entities after Static Seisa: %s" % ranked_expanded_entities)
    return ranked_expanded_entities
